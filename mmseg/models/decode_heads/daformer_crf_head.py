...
from .decode_head import BaseDecodeHead, CRF
...
class DAFormerCRFHead(BaseDecodeHead):

    def __init__(self, **kwargs):
        super(DAFormerCRFHead, self).__init__(
        ...
        # define CRF
        self.n_spatial_dims=decoder_params['n_spatial_dims'],
        self.filter_size=decoder_params['filter_size'],
        self.crf = CRF(n_spatial_dims=self.n_spatial_dims, filter_size=self.filter_size) 
